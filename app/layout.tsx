...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/caged%20bird%20logo-phQfhvYAUAPt62bkDOt9bgZebxcmyP.png",
        width: 800,
        height: 400,
        alt: "Caged Bird Game",
      },
  ...
  twitter: {
    ...
    description: "Help free the caged bird by solving brain teasers! A fun and challenging puzzle game.",
    images: [
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/caged%20bird%20logo-phQfhvYAUAPt62bkDOt9bgZebxcmyP.png",
    ],
    creator: "@damilare_oo",
  },
    generator: 'v0.app'
  ...
  return (
    <html lang="en" className={`${inter.variable} ${poppins.variable}`}>
      <head>
        ...
        <meta
          property="og:image"
          content="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/caged%20bird%20logo-phQfhvYAUAPt62bkDOt9bgZebxcmyP.png"
        />
        <meta
